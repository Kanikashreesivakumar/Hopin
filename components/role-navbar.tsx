    ...
    switch (role) {
      ...
      case "passenger":
        return [
          ...
          { href: "/dashboard/passenger/events", label: "View Events", icon: <Ticket className="h-4 w-4 mr-2" /> },
      ...
      case "driver":
        return [
          ...
          { href: "/dashboard/driver/alerts", label: "Pickup Alerts", icon: <AlertCircle className="h-4 w-4 mr-2" /> },
